    ...
    <div class="container">
      <div class="result-container">
        <div class="result-card">
          <!-- Header -->
          <div
            class="result-header ${paymentSuccess ? 'success-header' : 'error-header'}"
          >
            ...
            <div class="result-title">
              <c:choose>
                ...
                <c:otherwise> Thanh toán thất bại! </c:otherwise>
              </c:choose>
            </div>
          ...
          <div class="action-buttons">
            <a
              href="${pageContext.request.contextPath}/service.jsp"
              class="btn-custom btn-primary-custom"
            >
              <i class="fas fa-concierge-bell me-2"></i>Xem dịch vụ khác
            </a>
            <a
              href="${pageContext.request.contextPath}/servicePayment?action=history"
