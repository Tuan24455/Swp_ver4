...
<html lang="vi">
    ...
    <body>
            ...
            <section class="hero-section animate__animated animate__fadeInDown">
                <div class="container">
                    <div class="hero-content text-center">
                        ...
                        <p class="hero-subtitle">Các tiện ích giúp bạn tận hưởng kỳ nghỉ một cách hoàn hảo</p>
                    </div>
                </div>
            </section>
                    ...
                    <div class="filter-modal-content animate__animated">
                        ...
                        <form method="post" action="service" class="filter-form">
                                ...
                                <div class="filter-group">
                                    ...
                                    <div class="price-inputs">
                                        <div class="input-group">
                                            ...
                                            <input type="number" name="priceFrom" value="${param.priceFrom}" min="0" class="form-input" />
                                        </div>
                                        <div class="input-group">
                                            <label class="input-label">Đến (VND)</label>
                                            <input type="number" name="priceTo" value="${param.priceTo}" min="0" class="form-input" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="filter-actions">
                                <button type="button" class="btn btn-reset" onclick="resetFilter()">Đặt lại</button>
                ...
                <div class="container">
                    <div class="section-header text-center mb-5">
                        ...
                        <p class="section-subtitle">
                            Có <strong>${fn:length(serviceList)}</strong> dịch vụ đang khả dụng
                        </p>
                    </div>

                    <div class="room-grid">
                        <c:forEach var="service" items="${serviceList}" varStatus="status">
                            <div class="room-card animate__animated animate__fadeInUp" style="animation-delay: ${status.index * 0.1}s">
                                <div class="room-image-container">
                                    <img src="${service.imageUrl}" alt="Dịch vụ ${service.serviceName}" class="room-image"/>
                                ...
                                <div class="room-content">
                                    ...
                                    <div class="room-actions">
                                        <a href="serviceDetail?id=${service.getId()}" class="btn btn-view-detail">
                        ...
                        <nav class="pagination-nav" aria-label="Phân trang">
                            <ul class="pagination-list">
                                <li class="pagination-item ${currentPage == 1 ? 'disabled' : ''}">
                                    <button class="pagination-link" type="button" onclick="goToPage(${currentPage - 1})">
        ...
        <form id="paginationForm" method="get" action="service" style="display: none;">
