...
<nav id="navbar"> <div id="navbar-left"> <a href="home" style="text-decoration: none"><img class="logo" src="images/logo/logo.png" alt="Logo"/></a>
    ...
    <div id="navbar-right"> <div id="dropdown"> <button id="dropdown-toggle" onclick="toggleDropdown()"><i class="fas fa-user-circle fa-2x"></i></button> <div id="userDropdown" class="dropdown-menu"> <c:choose>
                    ...
                    <c:when test="${sessionScope.user.getRole() == 'Customer'}">
                        <span class="dropdown-item">Hello, ${sessionScope.user.getFullName()}</span> <a href="information" class="dropdown-item"><i class="fas fa-user"></i> Thông tin cá nhân</a> <a href="#" class="dropdown-item"><i class="fas fa-key"></i> Đổi mật khẩu</a> <a href="#" class="dropdown-item"><i class="fas fa-history"></i> Lịch sử chi tiêu</a><a href="bookingHistory" class="dropdown-item"><i class="fa-solid fa-list"></i> Danh sách đặt hàng</a> <a href="logout" class="dropdown-item"><i class="fas fa-sign-out-alt"></i> Đăng xuất</a> </c:when>
